...
from nsfw import CMD_LIST, LOAD_PLUG, tbot
import glob
import sys
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"nsfw/modules/{shortname}.py")
        name = "nsfw.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["nsfw.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "nsfw/modules/*.py"
